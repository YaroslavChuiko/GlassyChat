...
export default function Avatar({
  ...
  const getColorStyle = (color: Color) => {
    switch (color) {
      case "ROOM_COLOR_1":
      case "USER_COLOR_1":
        return "bg-red-9 text-red-12";
      case "ROOM_COLOR_2":
      case "USER_COLOR_2":
        return "bg-purple-9 text-purple-12";
      case "ROOM_COLOR_3":
      case "USER_COLOR_3":
        return "bg-cyan-9 text-cyan-12";
      case "ROOM_COLOR_4":
      case "USER_COLOR_4":
        return "bg-green-9 text-green-12";
      case "ROOM_COLOR_5":
      case "USER_COLOR_5":
        return "bg-orange-9 text-orange-12";
      default:
        return "bg-purple-9 text-purple-12";
    }
  };
    ...
    >
      ...
      <AvatarRadix.Fallback
        className={`${getColorStyle(
          color
        )} first-letter:text-violet11 leading-1 flex h-full w-full items-center justify-center bg-red-9 text-[20px] font-medium`}
        delayMs={600}
      >
        {getAcronym(name)}
      </AvatarRadix.Fallback>
